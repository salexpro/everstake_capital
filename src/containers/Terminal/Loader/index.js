  ...
  return visible ? (
    <Container className={s.wrap}>
      ...
      <div className={s.content}>
        ...
        <span>
          1.834079: pul mode[1] txringsize[ 256) txsendasize[1024) reapmin( 32)
          reapcount( 1281
        </span>
        <span>
          ...
          the SuperSpeed device (HubDevice) at Ox 15500000, asked for 400mA but
          got OMA
        </span>
        <span>
        ...
        <span>HDAEnabler: 05/05/2008 Added SP-Audio support by Blockchain</span>
        <span>
        ...
        <span>
          Everstake 16X5QUARTSync1: Detected 16550AF/C/CF FIFO=16 MaxBaud=115200
        </span>
        <span>HDAEnabler: Copyright (c) 2008 by Kabyl</span>
        <span>
          HDAEnabler: 05/05/2008 Added SP-fludio support by Blockchain
        </span>
        <span>HDAEnabler: 03/07/2009 Compiled for 32/64-bit by Blockchain</span>
        <span>HDAEnabler: Copyright (c) 2008 by Kabyl</span>
        <span>HDAEnabler: 05/05/2008 Added SP-Audio support by Blockchain</span>
        <span>HDAEnabler: 03/07/2009 Compiled for 32/64-bit by Blockchain</span>
        ...
        <span>
          ...
          TransportShowsUp] -- Connected to the transport successfully -- Oxd400
          -- Ox8000 -- Oxa000 ****
        </span>
        <span />
        <span />
